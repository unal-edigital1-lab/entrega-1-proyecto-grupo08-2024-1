...
En la simulación se muestra solamente los datos enviados a la FPGA. Por medio del analizador lógico, se pudieron observar los datos de respuesta por parte del sensor y de esta manera identificar que son 14 datos de lectura(contando uno por parte del maestro). A continuación, se muestra que a partir del estado S_READ0 del [mpu6050.v](Tamagotchi/mpu6050/mpu6050.v), se comienza la lectura de datos que se almacena en el registro XREG instanciado en las últimas líneas de código del [demompu6050.v](Tamagotchi/mpu6050/demo_mpu6050.v). Este registro, como se observa en la simulación hecha, se activa apenas se llegua al estado de lectura y en este caso, puesto que en la simulación no se enviaron datos de parte del esclavo, se muestra como el envío de un bit (como alta impedancia). No obstante, para no simular entradas aleatorias y confirmando que los datos son válidos, se expone adicionalmente los datos recibidos por medio del analizador lógico.
